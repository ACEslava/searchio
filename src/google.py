        ...
        try:
            ...
            def definition_embed(word, response_) -> list[Embed]:
                ...
                for definition in word["definitions"]:
                    embeds_.append(
                        Embed(
                            title=f'Definition of: {response_["word"]}',
                            description="\n".join(
                                [
                                    f'{response_["word"]}',
                                    f'`{response_["phonetics"][0]["text"]}`',
                                    "\n",
                                    f'{word["partOfSpeech"]}',
                    ...
                    embeds_[-1].add_field(
                        ...
                        value=response_["phonetics"][0]["audio"],
                        inline=False,
                    )
                    embeds_[
                        -1
                    ].url = f'https://www.merriam-webster.com/dictionary/{response_["word"]}'
                return embeds_
