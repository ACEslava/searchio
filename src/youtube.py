            ...
            while doExit == False:
                try:
                    ...
                    if str(reaction.emoji) == '🗑️':
                        ...
                        downloadmessage = await ctx.send(f'{get_loading_message()} <a:loading:829119343580545074>')
                        ...
                        if round(download.filesize_approx/1000000, 2) < 100:
                            ...
                            if str(dlreaction.emoji) == '👍':
                                ...
                                await downloadmessage.edit(content=f'{get_loading_message()} <a:loading:829119343580545074>', embed=None)
